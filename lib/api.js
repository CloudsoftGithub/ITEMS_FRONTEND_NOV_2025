...
const ITEMSApi = {
  ...
  // CREDIT HOURS
  listCreditHours: async () =>
    (await axiosInstance.get("/api/credit_hours")).data || [],

  createCreditHours: async (data) =>
    (await axiosInstance.post("/api/credit_hours/create", data)).data,

  // APPLICANTS

  listApplicants: async () =>
    (await axiosInstance.get("/api/applicants/all")).data || [],

  getApplicantById: async (id) =>
    (await axiosInstance.get(`/api/applicants/${id}`)).data,

  createApplicant: async (data) =>
    (await axiosInstance.post("/api/applicants/create", data)).data,

  updateApplicant: async (id, data) =>
    (await axiosInstance.put(`/api/applicants/update/${id}`, data)).data,

  deleteApplicant: async (id) =>
    (await axiosInstance.delete(`/api/applicants/delete/${id}`)).data,
